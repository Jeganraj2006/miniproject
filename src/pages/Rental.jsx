...
import ag8 from '../Images/ag8.jpg'
import ag9 from '../Images/ag9.jpg'
import ag10 from '../Images/ag10.webp'
      ...
      <div className='pt-30'>
            ...
            <section className='mt-10'> 
              <div className='grid grid-cols-4 gap-5 space-y-20 items-center justify-center ml-15'>
                ...
                <div className=' w-50 relative h-50 rent_list'>
                  <img src={ag8} alt="" className='object-cover h-50 w-50 rounded-xl'/>
                  <div className='justify-center'>
                    <h1 className="text-2xl font-semibold text-slate-700 ">Name</h1>
                    <h1>Price:</h1>
                    <h3>Rating</h3>
                ...
                <div className=' w-50 relative h-50 rent_list'>
                  <img src={ag9} alt="" className='object-cover h-50 w-50 rounded-xl'/>
                  <div className='justify-center'>
                    <h1 className="text-2xl font-semibold text-slate-700 ">Name</h1>
                    <h1>Price:</h1>
                    <h3>Rating</h3>
                ...
                <div className=' w-50 relative h-50 rent_list'>
                  <img src={ag10} alt="" className='object-cover h-50 w-50 rounded-xl'/>
                  <div className='justify-center'>
                    <h1 className="text-2xl font-semibold text-slate-700 ">Name</h1>
                    <h1>Price:</h1>
                    <h3>Rating</h3>
