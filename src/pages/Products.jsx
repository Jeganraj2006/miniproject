...
const Products = () => {
  ...
  const handleAddToCart = (product) => {
    const cartItem = {
      ...product,
      table: 'products', // Mark as product
    };
    addToCart(cartItem); // Add to cart

    // Log the table name when the product is added to the cart
    console.log('Added to cart from table:', cartItem.table); // Logs 'products'
  };
